<?php
	...
	if ($estAdmin){
		...
		updateAdmin(getAdminId($_COOKIE["user"]), $_POST['nom'], $_POST['prenom'], $_POST['dateNaissance'], $_POST['civilite'], $_POST['email'], $_POST['passwd'],  
	$_POST['numTel'], $_POST['ville'], $_POST['rue'], $_POST['numAd']);
		$myself = getAdmin(getAdminId($_COOKIE["user"]));
	}
	else{
		include_once('../Model/Interimaire.php');
		update(getInterimaireId($_COOKIE["user"]), $_POST['nom'], $_POST['prenom'], $_POST['dateNaissance'], $_POST['civilite'], $_POST['email'], $_POST['passwd'],  
	$_POST['numTel'], $_POST['ville'], $_POST['rue'], $_POST['numAd']);
